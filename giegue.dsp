...
shader="[DEFAULT]"
texture="/test/giygas.png"
texture_stretch="STRETCH_TILE"
opacity=1.0
screen_size=Vector2( 252, 221 )
move=Vector2( 0, 0 )
...
interlaced_amplitude=Vector2( 1, 0 )
interlaced_frequency=Vector2( 10, 0 )
interlaced_speed=Vector2( 4, 0 )
inter_amp_ping_pong=Vector2( 0, 0 )
inter_trans_ping_pong=Vector2( 0, 0 )
palette_shifting_speed=0.0
palette_shifting=false
palette_anim_frame_count=0
barrel=false
effect=1.0
effect_scale=2.0
