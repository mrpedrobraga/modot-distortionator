...
shader="[DEFAULT]"
texture="/test/eight.png"
texture_stretch="STRETCH_TILE"
opacity=1.0
...
interlaced_amplitude=Vector2( -0.2, 0 )
interlaced_frequency=Vector2( 2, 0 )
interlaced_speed=Vector2( 2, 0 )
inter_amp_ping_pong=Vector2( 0, 0 )
inter_trans_ping_pong=Vector2( 0, 0 )
palette_shifting_speed=4.0
palette="[Resource]/test/palettes/green-bidi.png"
palette_shifting=true
palette_anim_frame_count=30.0
barrel=false
effect=1.0
effect_scale=2.0
